...
const Home = () => {
	...
	}, [timer, active, countdown, alert]);  //Array de dependencias
		...
		<main className="text-center">
			...
			<section className="container text-center my-5">
				<h2>Counter Controller</h2>
					<div>
						<button disabled={active} onClick={startStop}className="mx-1 btn btn-success">Start</button>
						<button	disabled={!active} onClick={startStop}className="mx-1 btn btn-secondary">Stop</button>
